...
if (isset($wp_query) && (bool)$wp_query->is_posts_page) :
    ...
    <section class="simple-hero orange">
        <div class="container">
            ...
            <div class='post-grid'>
                ...
                if ($query->have_posts()) :
                    while ($query->have_posts()) :
                        ...
                        $date = date_i18n('d F Y', strtotime(get_post($id)->post_date));
