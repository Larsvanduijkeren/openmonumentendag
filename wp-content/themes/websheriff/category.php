    ...
    <section class="simple-hero orange">
        <div class="container">
            <div class="content" data-aos="fade-up">
                <span class="label">Categorie: <?php echo $category->name; ?></span>
                ...
                <!--                            href='-->
                <?php //echo get_category_link($cat->term_id); ?><!--'>--><?php //echo $cat->name ?>
                <!--                        </a>-->
                <!--                    --><?php //endforeach; ?>
                <!--                </div>-->
            </div>
                                ...
                                <span class="btn-stop-motion" data-wiggle data-sprite>
                                    <div class="btn-stop-motion__inner">
                                        <div class="btn-stop-motion__back">
                                            <svg class="btn-stop-motion__back-svg" xmlns="http://www.w3.org/2000/svg"
